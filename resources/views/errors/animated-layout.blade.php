...
<head>
    ...
    <style>
        ...
        .wrapper .container .text article a {
            ...
            border-radius: 50px;
            cursor: pointer;
            box-shadow: 0px 15px 20px rgb(54 24 79 / 50%);
            z-index: 3;
            color: #695681;
...
<section class="wrapper">
    <div class="container">
        <div id="scene" class="scene" data-hover-only="false">
            ...
            <p class="p404" data-depth="0.50">@yield('code')</p>
            <p class="p404" data-depth="0.10">@yield('code')</p>
        </div>

        <div class="text">
            <article>
                <p>@yield('message')</p>
                <a href="{{ route('website.home') }}">Go Home</a>
            </article>
        </div>
