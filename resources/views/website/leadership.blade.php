            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="page__title-wrapper mt-110">
                        <h3 class="page__title">Governing Council</h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('website.home') }}">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Governing Council</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                            <div class="teacher__item text-center grey-bg-5 transition-3 mb-30">
                                <div class="teacher__thumb w-img fix">
                                    <a>
                                        <img
                                            src="{{ asset('website_assets/img/board-of-directors/' . $bot->image) }}"
