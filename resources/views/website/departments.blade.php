            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="page__title-wrapper mt-110">
                        <h3 class="page__title">Departments</h3>
...
@section('content')
    <div style="background: #F2C85C;"
        ...
        <h3 class="mb-0 text-uppercase">General Nursing</h3>
    </div>
    <div class="course__tab-inner bg-light rounded mb-50" style="text-align: justify;">
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque deserunt distinctio dolor eius et expedita
            facilis fuga impedit, ipsam, ipsum iste magnam nostrum obcaecati quam qui saepe temporibus ut veritatis!</p>
    </div>
@endsection
