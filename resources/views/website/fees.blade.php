            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="page__title-wrapper mt-110">
                        <h3 class="page__title">School Fees</h3>
...
@endsection
@section('content')
    <div style="background: #F2C85C;" class="course__tab-inner mb-10 d-sm-flex justify-content-between align-items-center">
        <h3 class="mb-0 text-uppercase">School Fees</h3>
    </div>
    <div class="course__tab-inner bg-light rounded tab_links" style="text-align: justify;">
        <ul>
            <li>The course is completely self-sponsored.</li>
            <li>All School fees and other charges shall be as determined by the Governing Council subject to review from time to time.</li>
        </ul>
    </div>
@endsection
