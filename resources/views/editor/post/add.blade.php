    ...
    <div class="container-fluid">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <div class="nk-block">
                    <form class="container" id="needs-validation" novalidate action="{{ route('post.store') }}"
                          enctype="multipart/form-data" method="POST">
                        @if(session('status'))
                            <div class="alert alert-pro alert-success">
                                <div class="alert-text"><h6>Post Successfully added</h6>
                                    <p>{{ session('status') }}</p>
                                    <a href="{{ route('post.show', session('post')) }}" class="btn btn-primary btn-sm">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="tags"
                                       ...
                                       id="tags" required  value="{{ old('tags') }}">
                                @error('tags')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                                @enderror
                                <small>
                                    Use comma(,) to seperate each tag.
                                </small>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="datetime-local" name="date_of_event"
                                       class="form-control form-control-lg @error('date_of_event') is-invalid @enderror"
                                       id="date_of_event" required  value="{{ old('date_of_event') }}">
                                @error('date_of_event')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                <label for="summary">Summary <strong
                                        class="summary_count badge badge-danger">0</strong></label>
                                <textarea class="form-control @error('summary') is-invalid @enderror" required
                                          name="summary" id="summary" minlength="100" rows="5"
                                          style="resize: none; padding: 10px;">{{ old('summary') }}</textarea>
                                @error('summary')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('post') is-invalid @enderror" required
                                          name="post" id="post" cols="20" rows="10">{{ old('post') }}</textarea>
                                @error('post')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
