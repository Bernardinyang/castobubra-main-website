            ...
            <div class="nk-content-body">
                ...
                <div class="nk-block">
                    <form class="container" id="needs-validation" novalidate
                          action="{{ route('academic-staff.update', $academic_staff->id) }}"
                        ...
                        <div class="row">
                            <div class="col-md-5 mb-3">
                                ...
                                <input type="text" name="names"
                                       ...
                                       id="names" placeholder="Names" required value="{{ $academic_staff->names }}">
                                @error('names')
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="url" name="facebook_url"
                                           ...
                                           value="{{ $academic_staff->facebook_url }}">
                                    @error('facebook_url')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="url" name="twitter_url"
                                           ...
                                           value="{{ $academic_staff->twitter_url }}">
                                    @error('twitter')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="url" name="instagram_url"
                                           ...
                                           value="{{ $academic_staff->instagram_url }}">
                                    @error('instagram')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="url" name="linkedin_url"
                                           ...
                                           value="{{ $academic_staff->linkedin_url }}">
                                    @error('linkedin_url')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="email" name="email"
                                           ...
                                           id="email" placeholder="Email" value="{{ $academic_staff->email }}">
                                    @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('biography') is-invalid @enderror" required
                                          ...
                                          rows="10">{{ old('biography') ?? $academic_staff->biography }}</textarea>
                                @error('biography')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
