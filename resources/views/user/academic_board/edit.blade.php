            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content"><h3 class="nk-block-title page-title">Edit Board Member</h3>
                        </div>
                ...
                <div class="nk-block">
                    <form class="container" id="needs-validation" novalidate
                              action="{{ route('academic-board.update', $academic_board->id) }}"
                        ...
                        <div class="row">
                            <div class="col-md-5 mb-3">
                                ...
                                <input type="text" name="names"
                                       ...
                                       id="names" placeholder="Names" required value="{{ $academic_board->names }}">
                                @error('names')
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="position"
                                       ...
                                       id="position" placeholder="Position" required value="{{ $academic_board->position }}">
                                @error('position')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="url" name="facebook_url"
                                           ...
                                           value="{{ $academic_board->facebook_url }}">
                                    @error('facebook_url')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="url" name="twitter_url"
                                           ...
                                           id="twitter" placeholder="Twitter" value="{{ $academic_board->twitter_url }}">
                                    @error('twitter')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="url" name="instagram_url"
                                           ...
                                           value="{{ $academic_board->instagram_url }}">
                                    @error('instagram')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="url" name="linkedin_url"
                                           ...
                                           value="{{ $academic_board->linkedin_url }}">
                                    @error('linkedin_url')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="email" name="email"
                                           ...
                                           id="email" placeholder="Email" value="{{ $academic_board->email }}">
                                    @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
