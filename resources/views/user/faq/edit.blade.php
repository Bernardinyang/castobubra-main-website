            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content"><h3 class="nk-block-title page-title">Edit FAQ</h3>
                        </div>
                    ...
                    <form class="container" id="needs-validation" novalidate
                        ...
                        @if(session('status'))
                            <div class="alert alert-pro alert-success">
                                <div class="alert-text"><h6>FAQ Successfully updated</h6>
                                    <p>{{ session('status') }}</p>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" name="question"
                                       ...
                                       id="question" placeholder="Enter the question" required value="{{ $faq->question }}">
                                @error('question')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="order"
                                       ...
                                       id="order" placeholder="Order (lower numbers appear first)" value="{{ $faq->order }}" min="0">
                                @error('order')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
