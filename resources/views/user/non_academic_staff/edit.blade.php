            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content"><h3 class="nk-block-title page-title">Edit Staff Member</h3>
                        </div>
                        <div class="nk-block-head-content">
                            <div class="toggle-wrap nk-block-tools-toggle">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    @include('partials.dashboard.__header_action', ['data' => 'academic-staff', 'id' => $non_academic_staff->id])
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="nk-block">
                    <form class="container" id="needs-validation" novalidate
                          action="{{ route('academic-staff.update', $non_academic_staff->id) }}"
                        ...
                        <div class="row">
                            <div class="col-md-5 mb-3">
                                ...
                                <input type="text" name="names"
                                       ...
                                       id="names" placeholder="Names" required value="{{ $non_academic_staff->names }}">
                                @error('names')
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="position"
                                       ...
                                       value="{{ $non_academic_staff->position }}">
                                @error('position')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="url" name="facebook_url"
                                           ...
                                           value="{{ $non_academic_staff->facebook_url }}">
                                    @error('facebook_url')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="url" name="twitter_url"
                                           ...
                                           value="{{ $non_academic_staff->twitter_url }}">
                                    @error('twitter')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="url" name="instagram_url"
                                           ...
                                           value="{{ $non_academic_staff->instagram_url }}">
                                    @error('instagram')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="url" name="linkedin_url"
                                           ...
                                           value="{{ $non_academic_staff->linkedin_url }}">
                                    @error('linkedin_url')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="email" name="email"
                                           ...
                                           id="email" placeholder="Email" value="{{ $non_academic_staff->email }}">
                                    @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('biography') is-invalid @enderror" required
                                          ...
                                          rows="10">{{ old('biography') ?? $non_academic_staff->biography }}</textarea>
                                @error('biography')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
