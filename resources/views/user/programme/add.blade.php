                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Add Programme</h3>
                        </div>
                        <div class="nk-block-head-content">
                            ...
                            <form action="{{ route('programme.store') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" class="form-control" id="code" name="code" value="{{ old('code') }}" placeholder="e.g., CS101">
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <label for="type" class="form-label">Programme Type <span class="text-danger">*</span></label>
                                        <select class="form-control" id="type" name="type" required>
                                            <option value="">Select Type</option>
                                            <option value="ND" {{ old('type') == 'ND' ? 'selected' : '' }}>ND (National Diploma)</option>
                                            <option value="HND" {{ old('type') == 'HND' ? 'selected' : '' }}>HND (Higher National Diploma)</option>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="number" class="form-control" id="duration" name="duration" value="{{ old('duration') }}" min="1" placeholder="e.g., 2">
                                    </div>
                                    <div class="col-md-6 mb-4">
