                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Manage GRIDNOX Contacts Messages</h3>
                        </div>
                    </div>
                </div>
                <div class="nk-block">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                            @foreach($gridnoxs as $key => $gridnox)
                                <tr>
                                    <th scope="row">{{ $key + 1 }}</th>
                                    <td>{{ $gridnox->names }}</td>
                                    <td>{{ $gridnox->email }}</td>
                                    <td>{{ $gridnox->mobile_no }}</td>
                                    <td>{{ substr($gridnox->message, 0, 30) }}...</td>
                                    <td>
                                        @if($gridnox->is_read)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group">
                                            <a href="{{ route('user.gridnox.show', $gridnox->unique_id) }}"
