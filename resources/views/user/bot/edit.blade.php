            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content"><h3 class="nk-block-title page-title">Edit Governing Council Member</h3>
                        </div>
                ...
                <div class="nk-block">
                    <form class="container" id="needs-validation" novalidate
                              action="{{ route('bot.update', $bot->id) }}"
                          enctype="multipart/form-data" method="POST">
                        @if(session('status'))
                            <div class="alert alert-pro alert-success">
                                <div class="alert-text"><h6>Governing Council Member Successfully added</h6>
                                    <p>{{ session('status') }}</p>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="row">
                            <div class="col-md-5 mb-3">
                                ...
                                <input type="text" name="names"
                                       ...
                                       id="names" placeholder="Names" required value="{{ $bot->names }}">
                                @error('names')
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="position"
                                       ...
                                       id="position" placeholder="Position" required value="{{ $bot->position }}">
                                @error('position')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="url" name="twitter_url"
                                           ...
                                           id="twitter" placeholder="Twitter" value="{{ $bot->twitter_url }}">
                                    @error('twitter')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-2 mb-sm-0">
                                    ...
                                    <input type="email" name="email"
                                           ...
                                           id="email" placeholder="Email" value="{{ $bot->email }}">
                                    @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
