            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content"><h3 class="nk-block-title page-title">Add Social Media</h3>
                        </div>
                ...
                <hr>
                <div class="nk-block">
                    <form class="container" id="needs-validation" novalidate action="{{ route('social-media.store') }}"
                          method="POST">
                        @if(session('status'))
                            <div class="alert alert-pro alert-success">
                                <div class="alert-text"><h6>Social Media Successfully added</h6>
                                    <p>{{ session('status') }}</p>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="name"
                                    ...
                                    <option value="Pinterest" {{ old('name') == 'Pinterest' ? 'selected' : '' }}>Pinterest</option>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="url" name="url"
                                       ...
                                       id="url" placeholder="https://..." required value="{{ old('url') }}">
                                @error('url')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
